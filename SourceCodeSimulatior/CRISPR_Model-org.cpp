...
//     fileForBacteria << "Spacers Acquired";  // Aqui Agregue esta linea para cotar los spacers ocupados!!!!!!!
...
// ###################################################################### Intento de Arbol!!!!! ######################################################################       
//     
//     fileForPhageTree << "(";  //   intento de Arbol!!!!!
//     for(int j=0;j<Db;j++){ 
//         fileForPhageTree << Blabel[j] << ",";  //   intento de Arbol!!!!!
//     }
//     fileForPhageTree << ");" << endl;  //   intento de Arbol!!!!!
    
    for(int j=0;j<Dp;j++){
        fileForPhageTree << timesOfRecord << "\t" << Plabel[j] << "\t" << "NA" << "\t" << time << endl;  // Intento de Arbol!!!!!    
    }  
...
//         cout << "t = " << time << "\n";
//         cout << "time = " <<  timesOfRecord << endl;        
        
        // ########### caulculation of Effective Diversity   ###############
        
        for(int i=0;i<Db;i++){
//             cout << "Db = " <<  Db << endl;
//             cout << "Bold[i] = " <<  Bold[i] << endl;
...
//                 cout << timesOfRecord << " " << time << " " << Blabel[i] << " " << Bold[i];
//                 cout << timesOfRecord << " " << time << " " << Blabel[i] << " " << Bold[i] << endl;  // Intento de Arbol!!!!!
//                 cout << "############### " << endl;  // Intento de Arbol!!!!!
//                 int tmpSPcounter = 0; // Aqui Agregue esta linea para contar los spacers ocupados!!!!!!!
                for(int j=0;j<NumOfSpacers;j++){
                    fileForBacteria << " " << Spacers[i][j];
//                     if (Spacers[i][j] != -1) {tmpSPcounter++;} // Aqui Agregue esta linea para cotar los spacers ocupados!!!!!!!
                }
//                 fileForBacteria << " " << tmpSPcounter; // Aqui Agregue esta linea para cotar los spacers ocupados!!!!!!!
                fileForBacteria << endl;
//                 cout << endl;
//                  ##################################################################!!!!!!!!!!
            }
...
//             fileForTimeSeriesData << timesOfRecord << " " << time << " " << Db << " " << Dp << " " << sumOfBacteria << " " << sumOfPhage << " " << effDb << " " << effDp << endl;
            
//             cout << timesOfRecord << " " << time << " " << Db << " " << Dp << " " << sumOfBacteria << " " << sumOfPhage << " " << effDb << " " << effDp << endl;




//  ################################################################################!!!!!!!!!!  
//                      SI SE CALCULA EL PDI ES aqui!!!!!!!!
...
//             vector<int>::iterator Nmax;
            
// //             vector<int> Nb;
//             vector<double> Nb(Bold, Bold + sizeof(Bold) / sizeof(Bold[0]));
            
            
//             cout << "time = " <<  timesOfRecord << endl;            
//             int tmp = 0;
//             cout << "Db = " <<  Db << endl;
//             cout << "NumofBact = " <<  sizeof(Bold) << endl;
//             for(int i=0;i<sizeof(Bold);i++){
            for(int i=0;i<Db;i++){
//                 cout << "Bold[" << i << "] = " <<  Bold[i] << endl;
...
//             cout << "Dp = " <<  Dp << endl;
            for(int i=0;i<Dp;i++){
//                 cout << "Pold[" << i << "] = " <<  Pold[i] << endl;
                sumOfPhage2 = sumOfPhage2 + Pold[i];
            }            

            
//             cout << "time = " <<  timesOfRecord << endl;
//             cout << "sumOfBacteria = " <<  sumOfBacteria << endl;
//             cout << "sumOfBacteria2 = " <<  sumOfBacteria2 << endl;
//             cout << "sumOfPhage2 = " <<  sumOfPhage2 << endl;
//             cout << "Nmax = " <<  Nmax << endl;
            
//             cout << "--------------------------" << "\n";
// //             cout << "Nb size = " << Nb.size() << "\n";
//             cout << "Nb size = " << sizeof(Bold) << "\n";
...
//             Nmax = max_element(Nb, Nb + (sizeof(Blabel)-1));
//             Nmax = max_element(Nb.begin(), Nb.end());
...
//                             cout << timesOfRecord << " " << time << " " << Blabel[i] << " " << Bold[i] << "\n" << Blabel[i] << " " << Blabel[j] << " " << Plabel[k] << endl;
//                             S=Sigma(Spacers[i],Spacers[j], Protospacers[]);
...
//                 cout << "PDI = " << PDI << "\n";
//                 cout << "###################" << "\n"; 
//             cout << timesOfRecord << " " << time << " " << Db << " " << Dp << " " << sumOfBacteria << " " << sumOfPhage << " " << effDb << " " << effDp << " " << PDI <<  endl;
...
//                 if(Bold[i]/sumOfBacteria > 0.01){  // !!!!! Quitar esto para poder ver todas las abundancias, PERO SE VUELVE LENTO A LA HORA DE GRAFICAR!!!                    
                int tmpSPcounter = 0; // Aqui Agregue esta linea para contar los spacers ocupados!!!!!!!
                for(int j=0;j<NumOfSpacers;j++){
                    if (Spacers[i][j] != -1) {tmpSPcounter++;} // Aqui Agregue esta linea para cotar los spacers ocupados!!!!!!!
                }                    
                    
//                     fileForBacteriaAbundance << timesOfRecord << " " << time << " " << Blabel[i] << " " << Bold[i] << endl;
                    fileForBacteriaAbundance << timesOfRecord << " " << time << " " << Blabel[i] << " " << Bold[i] << " " << tmpSPcounter << endl;// Aqui Agregue esta linea para cotar los spacers ocupados!!!!!!!
//                 }
//                    ##################################################################!!!!!!!!!!
            }
...
//                 if(Pold[i]/sumOfPhage > 0.01){  // !!!!!TAMBIEN Quitar esto para poder ver todas las abundancias, PERO SE VUELVE LENTO A LA HORA DE GRAFICAR!!!
...
//                    ##################################################################!!!!!!!!!!                
        ...
        /*
        cout << "sumOfPhage is " << sumOfPhage << endl;
        cout << "sumOfBacteria is " << sumOfBacteria << endl;
        cout << "BacteriaEvolutionRate is " << BacteriaEvolutionRate << endl;
        cout << "PhageEvolutionRate is " << PhageEvolutionRate << endl;
        cout << "evolulationRate is " << evolulationRate << endl;
        cout << "timeToEvolution is " << timeToEvolution << endl;
         */
...
//                                     cout << timesOfRecord << " " << time << " " << Db << " " << Bold[i] << endl;  // Intento de Arbol!!!!!
...
//                         cout << timesOfRecord << " " << time << " " << PlabelLargest << " " << endl;  // Intento de Arbol!!!!!
//                         cout << "------------------ " << endl;  // Intento de Arbol!!!!!
//                         cout << timesOfRecord << "\t" << PlabelLargest << "\t" << Plabel[i] << "\t" << time << endl;  // Intento de Arbol!!!!!
                        fileForPhageTree << timesOfRecord << "\t" << PlabelLargest << "\t" << Plabel[i] << "\t" << time << endl;  // Intento de Arbol!!!!!
                        break;
                    }
                }
            }
        }
        //cout << time << " " << Db << " " << Dp << endl;
